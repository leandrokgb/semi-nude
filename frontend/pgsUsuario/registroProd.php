...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../libs/rspnsv.css"
	...
	<div class="container">
		...
		<div class="main-login main-center">
			<form class="form-horizontal" action="../../backend/postProduto.php" method="post" name="fprod">
				...
				<div class="form-group" id="btn2g">
                    <button id="btn2" class="btn btn-primary btn-lg btn-block login-button"
