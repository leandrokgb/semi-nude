				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="text" name="nomep" class="form-control" placeholder="Nome da categoria" id="nomep">
						</div>
					</div>
				</div>
				<div class="form-group">
			...
			<table class="table table-hover table-bordered table-responsive">
                <thead>
                    <tr>
                        ...
                        <th width="50"><a href="?e=<?php echo $row['idtipo'] ?>" class="excl" >Excluir Categoria</a></th>
	               </tr>
                </thead>
				<tbody>
					<tr>
